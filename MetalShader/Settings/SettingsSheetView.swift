        ...
        NavigationStack {
            Form {
                ...
                DisclosureGroup("Halo", isExpanded: $isHaloExpanded) {
                    ...
                    SliderRowView(title: "Wave Inset", description: "Moves the glow wave inward from the edge.", value: $settings.halo.waveInsetPixels, range: -12...24, step: 0.5)
                    SliderRowView(title: "Wave Amplitude", description: "How far the halo wave protrudes in pixels.", value: $settings.halo.waveAmplitudePixels, range: 0...24, step: 0.5)
                    SliderRowView(title: "Wave Count", description: "Number of wave peaks around the halo.", value: $settings.halo.waveCount, range: 1...8, step: 0.1)
                    SliderRowView(title: "Wave Speed x", description: "Multiplier for wave travel speed.", value: $settings.halo.waveSpeedMultiplier, range: 0...4, step: 0.05)
                    SliderRowView(title: "Wave Speed +", description: "Constant speed added to wave travel.", value: $settings.halo.waveSpeedOffset, range: 0...2, step: 0.05)
